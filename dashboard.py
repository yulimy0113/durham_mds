...
SERVICE_ACCOUNT_FILE = "cohesive-scope-428317-j2-1857ab1b8213.json"
    ...
    if st.session_state.selected_option is not None and 'raw_df' in st.session_state:
        ...
        try:
            ...
            if 'pivot_df' in st.session_state and st.session_state.selected_wavelength is not None:
                ...
                spec_diff = preprocessor(st.session_state.pivot_df, st.session_state.selected_wavelength[0], st.session_state.selected_wavelength[1])
